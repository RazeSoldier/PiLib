...
class PiTest extends TestCase
{
    ...
    {
        $obj = new Pi( 'Physics.Gravity', [ 'm1' => 5.97237E24, 'm2' => 1.9891E30, 'r' => 149597870700 ], 100 );
    ...
    public function testScaleParam()
    {
        $obj = new Pi( 'Physics.Gravity', [ 'm1' => 5.97237E24, 'm2' => 1.9891E30, 'r' => 149597870700 ], 5 );
        $expected = '35427777352739616159555.8483';
        $this->assertSame( $expected, $obj->calculate() );
        $this->assertSame( $expected, $obj->getResult() );
    }
